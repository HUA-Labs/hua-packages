...
```typescript
// packages/hua/src/framework/branding/css-vars.ts
...
```typescript
// packages/hua/src/framework/branding/tailwind-config.ts
...
```typescript
import { generateCSSVariables } from '@hua-labs/hua/framework';
import { getConfig } from '@hua-labs/hua/framework';
...
```javascript
// tailwind.config.js
const { generateTailwindConfig } = require('@hua-labs/hua/framework');
const { getConfig } = require('@hua-labs/hua/framework');
...
`hua/framework` provides components that automatically apply branding configuration.
...
```tsx
import { BrandedCard } from '@hua-labs/hua/framework';
...
// After
import { BrandedButton, BrandedCard } from '@hua-labs/hua/framework';
```
...
import { useBrandingColor } from '@hua-labs/hua/framework';
