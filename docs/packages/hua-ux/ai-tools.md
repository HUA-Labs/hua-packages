# hua-ux AI Tools & Vibe Coding

## Overview

This document covers the strategy for supporting various AI tools for vibe coding and the layered architecture that enables both traditional developers and vibe coders to use hua-ux effectively.
...
**Auto-generated**: `create-hua-ux` generates this automatically.
...
1. Create project: `pnpm create hua-ux my-app`
...
- `create-hua-ux` scaffolding (AI-friendly structure)
