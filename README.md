...
| [HUA Docs](./apps/my-docs) | HUA UX 프레임워크 문서 | [docs.hua-labs.com](https://docs.hua-labs.com) |
| [HUA Official](./apps/my-site) | HUA Labs 공식 사이트 | [hua-labs.com](https://hua-labs.com) |
...
│   ├── my-api/            # SUM API 서버
│   ├── my-docs/           # 프레임워크 문서 사이트
│   └── my-site/       # HUA Labs 공식 사이트
├── packages/
