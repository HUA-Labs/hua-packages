        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="col-span-1 sm:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400">React Animation SDK</span>
              </div>
            </div>
            <p className="text-base text-gray-600 dark:text-gray-400 mb-6 max-w-lg leading-relaxed">
              ...
              성능 최적화된 애니메이션 라이브러리입니다.
            </p>
            <div className="flex space-x-4 mb-6">
              <a 
                href="https://github.com/hua-labs/hua-animation" 
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { href: '/simple-animation', label: 'Simple Animation' },
                { href: '/page-animation', label: 'Page Animation' },
                { href: '/smart-animation', label: 'Smart Animation' },
                { href: '/advanced', label: 'Advanced Animation' },
                { href: '/docs', label: '문서' }
              ].map((item) => (
                <li key={item.href}>
                  <a 
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { href: '/internal', label: '예제' },
                { href: 'https://github.com/hua-labs/hua-animation', label: 'GitHub' }
              ].map((item) => (
                <li key={item.href}>
                  <a 
                    href={item.href} 
