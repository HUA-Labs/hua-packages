...
export default function AdvancedSequence() {
  const [activeDemo, setActiveDemo] = useState<'sequence'>('sequence')

  const demos = [
    {
      id: 'sequence',
      title: 'useSequence',
      description: '복잡한 애니메이션 체인과 순차적 실행',
      code: `const sequence = useSequence({
  steps: [
    { action: 'fadeIn', duration: 500 },
    { action: 'slideUp', duration: 800, delay: 200 },
    { action: 'scaleIn', duration: 600, delay: 500 }
  ],
  loop: true,
  autoStart: false
})`
          ...
          <Panel className="p-6">
            ...
            <div className="flex justify-center">
              <div className="bg-gradient-to-r from-purple-500 to-pink-600 text-white p-8 rounded-lg text-center min-w-[300px]">
                <Icon name={"layers" as any} className="w-16 h-16 mx-auto mb-4" />
