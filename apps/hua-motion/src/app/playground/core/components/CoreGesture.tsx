...
export function CoreGesture() {
  const [activeDemo, setActiveDemo] = useState<'gesture' | 'gestureMotion'>('gesture')
  ...
  const demos = [
    {
      id: 'gesture',
      title: 'useGesture',
      description: '기본 제스처 인식',
      code: `const gesture = useGesture({
  ...
  onWheel: (e) => console.log('Wheel:', e)
    ...
    {
      id: 'gestureMotion',
      title: 'useGestureMotion',
      description: '제스처 기반 모션',
      code: `const motion = useGestureMotion({
  onDrag: { x: 0, y: 0 },
  onPinch: { scale: 1 },
  onWheel: { deltaY: 0 }
})`
          ...
          <Panel className="p-6">
            ...
            <div className="flex justify-center">
              <div className="bg-gradient-to-r from-pink-500 to-purple-600 text-white p-8 rounded-lg text-center min-w-[300px]">
                <Icon name={"hand" as any} className="w-16 h-16 mx-auto mb-4" />
