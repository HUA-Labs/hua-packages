...
export function CoreScroll() {
  const [activeDemo, setActiveDemo] = useState<'reveal' | 'progress'>('reveal')
  ...
  const demos = [
    {
      ...
      description: '스크롤 시 요소 나타남',
      code: `const motion = useScrollReveal({ 
  threshold: 0.5 
})`
    },
    {
      ...
      description: '스크롤 진행률 추적',
      code: `const motion = useScrollProgress()`
    }
  ]
