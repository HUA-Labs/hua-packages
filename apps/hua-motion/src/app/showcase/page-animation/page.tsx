...
import { usePageAnimations } from '@hua-labs/motion'
...
export default function PageAnimationPage() {
  ...
  return (
    <ShowcasePageLayout
      ...
      description="페이지 전환과 레이아웃 애니메이션으로 부드러운 사용자 경험을 만들어보세요"
      icon="layers"
      color="green"
      primaryButton={{
        text: "테스트 랩",
    ...
    >
      ...
      <section className="mb-24">
        ...
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl shadow-green-500/10 border border-green-200/50 dark:border-green-800/50">
      ...
      <section className="mb-24">
        ...
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl shadow-emerald-500/10 border border-emerald-200/50 dark:border-emerald-800/50">
      ...
      <section className="mb-24">
        ...
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl shadow-teal-500/10 border border-teal-200/50 dark:border-teal-800/50">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="text-center">
