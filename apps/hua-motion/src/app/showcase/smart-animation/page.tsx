...
import { useSmartAnimation } from '@hua-labs/motion'
...
export default function SmartAnimationPage() {
  ...
  return (
    <ShowcasePageLayout
      ...
      description="모든 애니메이션 기능을 한 곳에서 체험해보세요. 개별 요소별 완전한 제어가 가능합니다."
      icon="sparkles"
      color="purple"
      primaryButton={{
        text: "테스트 랩",
    ...
    >
      ...
      <section className="mb-24">
        ...
        <div 
          ref={cardRef.ref}
          style={cardRef.style}
          className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl p-12 shadow-2xl shadow-rose-500/10 border border-rose-200/50 dark:border-rose-800/50 relative overflow-hidden"
        >
          {/* 배경 패턴 */}
      ...
      <section className="mb-24">
        ...
        <div 
          ...
          className="bg-gradient-to-br from-red-500 via-orange-600 to-yellow-600 rounded-3xl p-12 shadow-2xl shadow-red-500/25 relative overflow-hidden"
        >
          {/* 배경 패턴 */}
