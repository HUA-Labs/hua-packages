...
import { Avatar, AvatarImage, AvatarFallback, Card, CardContent, ComponentLayout } from '@hua-labs/hua-ux'
...
{`import { Avatar, AvatarImage, AvatarFallback } from '@hua-labs/hua-ux'
