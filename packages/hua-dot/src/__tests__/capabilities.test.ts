...
describe('CAPABILITY_MATRIX', () => {
  it('has entries for all core families', () => {
    const families = [
      'spacing', 'color', 'typography', 'layout', 'sizing',
      'border', 'borderRadius', 'flexbox', 'opacity', 'zIndex',
      'shadow', 'transform', 'transition', 'animation',
      'filter', 'backdropFilter', 'mixBlendMode', 'grid',
    ];
