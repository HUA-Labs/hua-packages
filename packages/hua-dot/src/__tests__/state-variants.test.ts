...
describe('dotMap() — state variants', () => {
  ...
  it('routes hover: to hover bucket', () => {
    ...
    expect(result.hover).toEqual({ backgroundColor: '#dee1e4' });
  });
  ...
  it('routes active: to active bucket', () => {
    ...
    expect(result.base).toEqual({ backgroundColor: '#2b6cd6' });
    expect(result.active).toEqual({ backgroundColor: '#1e54a8' });
  });
  ...
  it('handles multiple state variants', () => {
    ...
    expect(result.base).toEqual({ backgroundColor: '#ffffff' });
    expect(result.hover).toEqual({ backgroundColor: '#dee1e4' });
    expect(result.focus).toEqual({ backgroundColor: '#c1c4c8' });
    expect(result.active).toEqual({ backgroundColor: '#a3a7ae' });
  });
  ...
  it('applies dark mode in base and state', () => {
    ...
    expect(result.base).toEqual({ backgroundColor: '#121418' });
    expect(result.hover).toEqual({ backgroundColor: '#dee1e4' });
  });
