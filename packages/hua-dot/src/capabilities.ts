...
export const PROPERTY_TO_FAMILY: Record<string, string> = {
  ...
  flexWrap: "flexbox",
  alignItems: "flexbox",
  alignSelf: "alignSelfDetail",
  justifyContent: "flexbox",
  flexGrow: "flexbox",
  flexShrink: "flexShrinkDetail",
  flex: "flexbox",
  order: "flexbox",
  ...
  "--tw-enter-opacity": "animation",
  "--tw-enter-scale": "animation",
  "--tw-exit-opacity": "animation",
  "--tw-exit-scale": "animation",
  "--tw-enter-translate-x": "animation",
  "--tw-enter-translate-y": "animation",
  "--tw-exit-translate-x": "animation",
  "--tw-exit-translate-y": "animation",
  ...
  scrollMarginTop: "scroll",
  scrollMarginRight: "scroll",
  scrollMarginBottom: "scroll",
  scrollMarginLeft: "scroll",
  scrollPaddingTop: "scroll",
  scrollPaddingRight: "scroll",
  scrollPaddingBottom: "scroll",
  scrollPaddingLeft: "scroll",
 ...
 */
const VALUE_OVERRIDES: Record<
  string,
  Record<string, Partial<Record<DotTarget, CapabilityLevel>>>
> = {
  display: {
