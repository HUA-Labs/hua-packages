...
export interface LandingHeroProps extends Omit<
...
export interface LandingFeaturesProps extends Omit<
  React.HTMLAttributes<HTMLElement>,
  "title"
> {
...
export interface LandingStatsProps extends Omit<
  React.HTMLAttributes<HTMLElement>,
  "title"
> {
...
export interface LandingCTAProps extends Omit<
  React.HTMLAttributes<HTMLElement>,
  "title" | "className"
> {
  title: ReactNode;
...
export interface LandingTestimonialsProps extends Omit<
  React.HTMLAttributes<HTMLElement>,
  "title"
> {
...
export interface LandingLogoCloudProps extends Omit<
  React.HTMLAttributes<HTMLElement>,
  "title" | "className"
> {
...
export interface LandingShowcaseProps extends Omit<
  React.HTMLAttributes<HTMLElement>,
  "title" | "className"
> {
...
export interface LandingAboutProps extends Omit<
  React.HTMLAttributes<HTMLElement>,
  "title" | "className"
> {
  name: string;
...
export interface LandingProjectsProps extends Omit<
  React.HTMLAttributes<HTMLElement>,
  "title"
> {
...
export interface LandingSkillsProps extends Omit<
  React.HTMLAttributes<HTMLElement>,
  "title"
> {
...
export interface LandingExperienceProps extends Omit<
  React.HTMLAttributes<HTMLElement>,
  "title"
> {
...
export interface LandingMetricsProps extends Omit<
  React.HTMLAttributes<HTMLElement>,
  "title"
> {
  items: LandingMetricItem[];
...
export interface LandingContactProps extends Omit<
  React.HTMLAttributes<HTMLElement>,
  "title" | "className"
> {
  /** 섹션 제목 */
