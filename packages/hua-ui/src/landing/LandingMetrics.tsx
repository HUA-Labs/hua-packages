          ...
          <div style={dot("flex gap-2 mb-8 justify-center")}>
            {tabs.map((tab, i) => (
              <button
                ...
                style={dot(
                  `px-4 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === i ? "bg-primary text-primary-foreground" : "bg-secondary text-secondary-foreground hover:bg-secondary/80"}`,
                )}
              >
                {tab.label}
              </button>
