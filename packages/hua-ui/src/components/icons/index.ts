...
// Export icon map
export const ICONSAX_ICONS: Record<string, IconsaxIcon> = {
  '3Dcube': Icon3Dcube,
  'Add': Add,
  'AddCircle': AddCircle,
  'AddSquare': AddSquare,
...
// Get icon by name
export function getIconsaxIcon(name: string): IconsaxIcon | null {
  return ICONSAX_ICONS[name] || null
}
