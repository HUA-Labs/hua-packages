...
// Essential icon map (57 icons)
export const ESSENTIAL_ICONSAX_ICONS: Record<string, IconsaxIcon> = {
  'Add': Add,
  'ArrowDown': ArrowDown,
...
// Get essential icon by name
export function getEssentialIconsaxIcon(name: string): IconsaxIcon | null {
  return ESSENTIAL_ICONSAX_ICONS[name] || null
}
