 ...
 */
export interface CheckboxProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, 'size' | 'className'> {
...
const CHECKED_STYLE: React.CSSProperties = {
  ...
  boxShadow: '0 1px 3px color-mix(in srgb, var(--color-primary) 20%, transparent)',
}

/** Error border override */
const ERROR_BORDER: React.CSSProperties = { borderColor: 'var(--color-destructive, hsl(0 84% 60%))' }
...
const Checkbox = React.forwardRef<HTMLInputElement, CheckboxProps>(
  ({
    ...
    const boxStyle = useMemo((): React.CSSProperties => {
      ...
      const hoverStyle = isHovered && !isChecked && !isDisabled ? HOVER_BORDER : undefined
      ...
      return mergeStyles(base, stateBorder, hoverStyle, checkedStyle, focusStyle, disabledStyle)
    }, [size, variant, isChecked, error, success, isFocused, isHovered, isDisabled])
