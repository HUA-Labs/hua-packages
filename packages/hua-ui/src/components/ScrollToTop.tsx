 ...
 */
export interface ScrollToTopProps extends Omit<React.HTMLAttributes<HTMLButtonElement>, 'className'> {
  threshold?: number
  smooth?: boolean
  icon?: IconName
  size?: "sm" | "md" | "lg"
...
const ScrollToTop = ({
  ...
  ...props
    ...
    return (
      <button
        onClick={scrollToTop}
        style={mergeStyles(resolveDot(baseClasses), resolveDot(dotProp), styleProp)}
