...
describe("resolveIconAlias", () => {
  ...
  it("should preserve canonical close and resolve cancel", () => {
    expect(resolveIconAlias("close")).toBe("close");
  ...
  it("should preserve canonical remove and resolve trash", () => {
    expect(resolveIconAlias("remove")).toBe("remove");
    expect(resolveIconAlias("trash")).toBe("delete");
  });

  it("should preserve canonical monitor and pencil mappings", () => {
    expect(resolveIconAlias("monitor")).toBe("monitor");
    expect(resolveIconAlias("pencil")).toBe("pencil");
  });
...
describe("getIconAliases", () => {
  ...
  it("should return array of aliases for x icon", () => {
    ...
    expect(aliases).not.toContain("close");
...
describe("ICON_ALIASES", () => {
  ...
  it("should not shadow canonical spellings with aliases", () => {
    expect(ICON_ALIASES["close"]).toBeUndefined();
    expect(ICON_ALIASES["remove"]).toBeUndefined();
    expect(ICON_ALIASES["monitor"]).toBeUndefined();
    expect(ICON_ALIASES["pencil"]).toBeUndefined();
