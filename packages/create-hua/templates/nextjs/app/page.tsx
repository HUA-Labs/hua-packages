      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-6 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center z-10">
          ...
          <div ref={ctaMotion.ref} style={ctaMotion.style} className="flex items-center justify-center gap-4 flex-wrap mb-12">
            ...
            <a href="https://github.com/HUA-Labs/hua-packages" target="_blank" rel="noopener noreferrer">
      ...
      <footer className="py-10 px-6 border-t border-border/30 relative z-10">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          ...
          <div className="flex items-center gap-5">
            ...
            <a href="https://github.com/HUA-Labs/hua-packages" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors flex items-center gap-1">GitHub <ExternalIcon /></a>
