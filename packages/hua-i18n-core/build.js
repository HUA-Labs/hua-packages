...
const log = (data) => {
  try {
    ...
    const logEntry = JSON.stringify({
      ...
      timestamp: Date.now(),
      location: 'build.js:entry',
      message: data.message || 'build.js execution',
      data: data,
...
try {
  // Use process.execPath instead of 'node' to avoid PATH issues
