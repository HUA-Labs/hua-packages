...
hua provides an i18n middleware for use in Next.js middleware. It detects the language of the request and sets it in the response headers.
...
import { createI18nMiddleware } from '@hua-labs/hua/framework/server'
```
