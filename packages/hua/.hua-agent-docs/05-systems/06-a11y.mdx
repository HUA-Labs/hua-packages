...
hua-ux provides accessibility components and hooks for WCAG compliance from the framework entry.
...
```tsx
import { LiveRegion } from '@hua-labs/hua-ux/framework'
...
```tsx
import { useLiveRegion } from '@hua-labs/hua-ux/framework'
...
```tsx
import { SkipToContent, LiveRegion } from '@hua-labs/hua-ux/framework'
