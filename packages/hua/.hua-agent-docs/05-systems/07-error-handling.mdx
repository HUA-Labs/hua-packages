...
hua-ux extends React's ErrorBoundary pattern to provide automatic error handling in HuaUxPage.
...
```tsx
// Internal structure of HuaUxPage
function HuaUxPage({ children, enableErrorBoundary = true, ... }) {
  const content = (
