...
export interface SmartMotionOptions<
  T extends HTMLElement = HTMLElement,
> extends BaseMotionOptions {
  type?: MotionType;
  entrance?: EntranceType;
  hover?: boolean;
  click?: boolean;
...
export interface SmartMotionReturn<
  T extends HTMLElement = HTMLElement,
...
export type OrchestrationConfig = SequenceOrchestrationConfig;

export interface SequenceOrchestrationConfig {
