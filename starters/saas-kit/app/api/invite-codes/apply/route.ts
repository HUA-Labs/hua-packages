    ...
    await prisma.$transaction([
      ...
      prisma.userQuota.upsert({
        ...
        create: {
          ...
          daily_resource_limit: inviteCode.is_premium ? 50 : 10,
          monthly_resource_limit: inviteCode.is_premium ? 1500 : 300,
          daily_api_limit: inviteCode.is_premium ? 50 : 10,
          monthly_api_limit: inviteCode.is_premium ? 1500 : 300,
