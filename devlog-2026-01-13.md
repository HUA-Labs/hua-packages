...
**파일:** `apps/my-docs/app/docs/getting-started/page.tsx`

### 3. 검색 기능 구현 (Cmd+K / Ctrl+K)

**새로운 파일:**
- `apps/my-docs/components/SearchCommand.tsx`
...
**새로운 파일:** `apps/my-docs/constants/packages.ts`
...
**문서 페이지 추가:**
- `apps/my-docs/app/docs/hooks/page.tsx` - 훅 개요
- `apps/my-docs/app/docs/hooks/use-in-view/page.tsx`
- `apps/my-docs/app/docs/hooks/use-scroll-progress/page.tsx`
- `apps/my-docs/app/docs/hooks/use-mouse/page.tsx`
- `apps/my-docs/app/docs/hooks/use-window-size/page.tsx`
- `apps/my-docs/app/docs/hooks/use-reduced-motion/page.tsx`
...
```json
// apps/my-site/vercel.json, apps/my-docs/vercel.json
{
