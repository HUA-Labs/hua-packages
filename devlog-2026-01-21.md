...
**변경 파일:**
- `apps/my-docs/components/docs/ComponentDocNavigation.tsx`
...
**변경 파일:**
- `apps/my-docs/components/docs/HookDocNavigation.tsx`
...
**파일:** `apps/my-docs/app/docs/components/logo/page.tsx`
...
**파일:** `apps/my-docs/app/docs/components/scrollbar/page.tsx`
...
**변경 파일:**
- `apps/my-docs/public/translations/en/docs.json`
- `apps/my-docs/public/translations/ko/docs.json`
